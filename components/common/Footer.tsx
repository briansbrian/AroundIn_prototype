...
const Footer: React.FC = () => {
    return (
        <footer className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg text-gray-600 dark:text-gray-300 mt-auto">
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* About Section */}
                    <div className="md:col-span-2">
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">About Aroundin</h3>
                        <p className="text-sm">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Quick Links</h3>
                    ...
                    {/* Follow Us */}
                    <div>
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Follow Us</h3>
                ...
                <div className="border-t border-gray-200/50 dark:border-gray-700/50 mt-8 pt-4 text-center text-sm">
