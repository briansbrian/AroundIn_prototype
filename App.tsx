...
const App: React.FC = () => {
  ...
  const Navigation = () => {
    ...
    const handleReloadNavigation = (path: string) => {
    ...
    return (
      <nav className="flex items-center gap-6">
        <button
          onClick={() => handleReloadNavigation('/')}
        ...
        <button
          onClick={() => handleReloadNavigation('/vendor')}
          className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${
  ...
  return (
    <Router>
      <div className={`font-sans ${isDarkMode ? 'dark text-white' : ''} overflow-x-hidden`}>
